          ...
          <details className={styles.tree} onToggle={handleMainToggle(index)}>
            <summary>
              <input
                type={"checkbox"}
                id={main as string}
                onChange={updateCheckbox("main", main as string)}
              />
              <label
                      ...
                      <details key={idx} onToggle={handleMidToggle(idx)}>
                        <summary>
                          <input
                            type={"checkbox"}
                            id={middle as string}
                            onChange={updateCheckbox("middle", middle as string)}
                          />
                          <label
                              ...
                              >
                                <summary>
                                  <input
                                    ...
                                    onChange={updateCheckbox("sub", subData as string)}
                                  />
                                    ...
                                    <dl key={subData + v.policyId}>
                                      <dd>
                                        <input
                                          type={"checkbox"}
                                          id={v.name as string}
                                          onChange={updateCheckbox("name", v.name)}
                                        />
                                        <label
                                          htmlFor={v.name}
